/**
 * Victim-State Response Engine
 * 
 * Provides prioritized, structured incident response protocols
 * strictly based on EXPLICIT USER-DECLARED victim state.
 * 
 * CRITICAL ARCHITECTURAL CONSTRAINTS:
 * 1. USER DECLARED ONLY — Never infer victim interaction from message text or risk score.
 * 2. Does NOT alter deterministic risk assessment, indicators, or attack chain.
 * 3. Jurisdiction-neutral guidance with structured reporting channels.
 * 4. Zero server-side persistence or tracking of user victim state.
 */
...
export function generateVictimStateResponse(
